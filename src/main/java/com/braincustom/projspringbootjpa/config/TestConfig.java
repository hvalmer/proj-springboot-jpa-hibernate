package com.braincustom.projspringbootjpa.config;
...
import com.braincustom.projspringbootjpa.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//salvando os usuarios no BD
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		
		//associando os produtos com as categorias - objetos
		...
		//para salvar todos os produtos in-memoria...salvar os produtos com as associações feitas
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
